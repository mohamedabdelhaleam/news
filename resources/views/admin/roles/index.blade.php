                    ...
                    <div class="breadcrumb-main user-member justify-content-sm-between ">
                        ...
                        @can('add roles')
                            <div class="action-btn">
                                <a href="{{ route('admin.roles.add') }}" class="btn px-15 btn-primary">
                                    <i class="las la-plus fs-16"></i>Add Role</a>
                            </div>
                        @endcan
                    </div>
...
@section('script')
    <script>
        activateSearchInput("{{ route('admin.roles.index') }}", 'roles-table', 'pagination-links');
    </script>
@endsection
